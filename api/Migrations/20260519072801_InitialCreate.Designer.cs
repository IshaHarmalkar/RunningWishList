...
namespace api.Migrations
{
    ...
    [Migration("20260519072801_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.WishlistItemTag", b =>
                {
                    ...
                    b.HasKey("WishlistItemId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("WishlistItemTags");
                });
            ...
            modelBuilder.Entity("api.Models.WishlistItemTag", b =>
                {
                    b.HasOne("api.Models.Tag", "Tag")
                        .WithMany("WishlistItemTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("api.Models.WishlistItem", "WishlistItem")
                        .WithMany("WishlistItemTags")
